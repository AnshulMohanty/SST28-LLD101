 ...
 *
 * Self note:
 * yaha se direct new MarkerStyle nahi banega.
 * factory use karenge taaki style reuse ho sake.
 */
public class MapDataSource {
    ...
    public List<MapMarker> loadMarkers(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // yaha flyweight factory se shared style le rahe hain
            MarkerStyle style =
                    MarkerStyleFactory.get(shape, color, size, filled);
