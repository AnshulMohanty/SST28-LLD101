...
public final class IncidentTicket {
    ...
    private IncidentTicket(Builder builder) {
        ...
        // Defensive copy so outside list cannot modify internal state
        this.tags = Collections.unmodifiableList(new ArrayList<>(builder.tags));
    }

    // Getters (safe, no leakage)
    ...
    public static class Builder {
        ...
        private Builder(IncidentTicket ticket) {
            ...
            this.tags = new ArrayList<>(ticket.tags); // defensive copy
        ...
        public Builder tags(List<String> tags) {
            this.tags = new ArrayList<>(tags); // defensive
            return this;
        }
